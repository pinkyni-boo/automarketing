...
export const metadata={
  title:'Blog',
  description:'Nội dung thực tiễn, dễ áp dụng cho đội ngũ marketing và doanh nghiệp.',
  alternates:{canonical:'/blog'},
  openGraph:{title:'Blog | AutoMarketing',description:'Nội dung thực tiễn, dễ áp dụng cho đội ngũ marketing và doanh nghiệp.',url:'/blog',type:'website'},
  twitter:{card:'summary_large_image',title:'Blog | AutoMarketing',description:'Nội dung thực tiễn, dễ áp dụng cho đội ngũ marketing và doanh nghiệp.'},
};
